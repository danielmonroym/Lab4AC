.data
   #El programa debe tomar un vector de cien n�meros enteros que contiene valores entre -100 y
#100, y determinar cu�les son el mayor y el menor n�mero almacenados entre los elementos de
# �ndice par e impar, y cu�ntas veces se repite cada uno. 
...
mayoresImpares:
sw $t4,($s3) #se carga el n�mero en s3
